...
const tools = [
  ...
  { name: 'Simple Interest Calculator', description: 'Calculate interest amount earned in your investments', href: '#', icon: ChartBarIcon },
      ...
      <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
        <div className="flex lg:flex-1">
          <a href="/" className="-m-1.5 p-1.5">
            ...
            <img className="h-12 w-16" src="/Assets/Logo.jpeg" alt="logo" />
          </a>
        </div>
